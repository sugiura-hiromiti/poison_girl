...
*/
pub(in crate::raw::protocol::file) type FileOpen =
...
*/
pub(in crate::raw::protocol::file) type FileClose =
...
*/
pub(in crate::raw::protocol::file) type FileDelete =
	unsafe extern "efiapi" fn(this: *mut FileProtocolV1,) -> Status;
...
*/
pub(in crate::raw::protocol::file) type FileRead =
	unsafe extern "efiapi" fn(
		this: *mut FileProtocolV1,
		buf_size: *mut usize,
		buf: *mut c_void,
...
*/
pub(in crate::raw::protocol::file) type FileWrite =
	unsafe extern "efiapi" fn(
		this: *mut FileProtocolV1,
		buf_size: *mut usize,
		buf: *mut c_void,
...
*/
pub(in crate::raw::protocol::file) type FileGetPosition =
	unsafe extern "efiapi" fn(
...
*/
pub(in crate::raw::protocol::file) type FileSetPosition =
	unsafe extern "efiapi" fn(
		this: *mut FileProtocolV1,
		position: u64,
	) -> Status;
...
*/
pub(in crate::raw::protocol::file) type FileGetInfo =
	unsafe extern "efiapi" fn(
		this: *mut FileProtocolV1,
...
*/
pub(in crate::raw::protocol::file) type FileSetInfo =
	unsafe extern "efiapi" fn(
		this: *mut FileProtocolV1,
		info_type: *const Guid,
		buf_size: usize,
...
*/
pub(in crate::raw::protocol::file) type FileFlush =
	unsafe extern "efiapi" fn(this: *mut FileProtocolV1,) -> Status;
