...
Runs on pushes to `main` and manual dispatch. It builds the `doc` flake check and
publishes the generated rustdoc to GitHub Pages.
...
runners. It is intentionally not run for every pull request.
...
Independent scheduled PR health workflow. It does not define build behavior.
